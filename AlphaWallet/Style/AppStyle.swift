...
struct Colors {
    ...
    static let appTint = UIColor(red: 246, green: 154, blue: 0)    // swyft orange  R.color.azure()!
    ...
    static let appActionButtonGreen = UIColor(red: 246, green: 154, blue: 0)    // swyft orange
