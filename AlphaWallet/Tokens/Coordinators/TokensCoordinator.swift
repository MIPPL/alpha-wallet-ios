...
class TokensCoordinator: Coordinator {
    ...
    private func showServers(inViewController viewController: UIViewController) {
        ...
        coordinator.start()
        addCoordinator(coordinator)
        let serversViewControllerUINavigation = UINavigationController(rootViewController: coordinator.serversViewController)
        serversViewControllerUINavigation.modalPresentationStyle = .fullScreen
        viewController.present(serversViewControllerUINavigation, animated: true)
    }
